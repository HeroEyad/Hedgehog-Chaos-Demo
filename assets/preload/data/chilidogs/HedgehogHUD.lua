...
function onCreatePost()
    ...
    quickLuaText('misses', 'MISSES', 0, getProperty('score.x'), getProperty('combo.y') + 50, 60, 'HUD.ttf')
    setTextColor('misses', '0xECE400')
    quickLuaText('misses2', '', 0, getProperty('score.x') + 200, getProperty('combo.y') + 50, 60, 'HUD.ttf')

    setObjectOrder('misses', 19)
    setObjectOrder('misses2', 21)
...
function onUpdatePost()
    ...
    if hitNote == true then
        ...
        elseif getProperty('ratingPercent') >= 0.9 and getProperty('ratingPercent') < 1 then
            setTextString('AccuracyRating', 'SICK!')
        elseif getProperty('ratingPercent') >= 0.7 and getProperty('ratingPercent') < 0.9 then
            setTextString('AccuracyRating', 'Good')
        elseif getProperty('ratingPercent') >= 0.4 and getProperty('ratingPercent') < 0.7 then
            setTextString('AccuracyRating', 'Not Bad')
        elseif getProperty('ratingPercent') >= 0.1 and getProperty('ratingPercent') < 0.4 then
            setTextString('AccuracyRating', 'Bad')
        elseif getProperty('ratingPercent') < 0.1 then
    ...
    setProperty('misses.y', getProperty('combo.y') + 50)
    setProperty('missesColon.y', getProperty('combo.y') + 50)
    setProperty('misses2.y', getProperty('combo.y') + 50)
end
...
function onCreate()
    ...
    setTextFont('AccuracyText', '3.ttf')
    ...
    setTextFont('AccuracyRating', '3.ttf')
