...
class CreditCard extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, data:CreditMember)
	{
		...
		username.setFormat(Paths.font('sonic2.ttf'), 24, CENTER, OUTLINE, FlxColor.BLACK);
...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		titleBar.setFormat(Paths.font('sonic2.ttf'), 40, CENTER, OUTLINE, FlxColor.BLACK);
		titleBar.borderSize = 3;
		add(titleBar);

		descBar = new FlxText(0, FlxG.height - 60, FlxG.width, "", 40);
		descBar.setFormat(Paths.font('sonic2.ttf'), 40, CENTER);
		add(descBar);
