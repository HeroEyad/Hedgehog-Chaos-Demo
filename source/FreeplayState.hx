...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...songs.length)
		{
			...
			var songPortairt:PortrairFreeplay = new PortrairFreeplay(100, 0, songs[i].songName);
			songPortairt.lerpMenu = true;
			songPortairt.startPosition.y = ((FlxG.height - songPortairt.height)/2)-50;
			grpSongs.add(songPortairt);

			songPortairt.snapToPosition();

			
			var songText:PortrairFreeplay = new PortrairFreeplay(0, 0, songs[i].songName, true);
			// songText.lerpMenu = true;
			// songText.startPosition.y = ((FlxG.height - songPortairt.height)/2)-50;
			add(songText);

			songPortairt.snapToPosition();

			// var po:FlxSprite = new FlxSprite(Paths.image('Freeplay/portrair/' + songs[i].songName.toLowerCase()));
			// add(po);
